...
Validates detection of non-English words using PyEnchant dictionary checking.
"""
...
TEST_CASES = [
    ...
    (
        "Supercalifragilisticexpialidocious is hard to spell",
        True,
    ...
    (
        "Tacos quesadillas nachos guacamole",
        False,
    ),  # These Spanish words are now in English dictionary
]


@pytest.mark.parametrize("text,expected", TEST_CASES)
def test_contains_non_english_comprehensive(text, expected):
    """Test non-English word detection across various languages and scenarios."""
